...
<body>
<form action="mapInsert.mp" method="post">
    <input type="text" id="bid" placeholder="회사명" name="business_name"><br>
    <input type="text" id="postNum" placeholder="주소" name="postNum">
	<input type="text" id="sample5_address" placeholder="주소" name="business_addr">
